      ...
      <section className="section-padding">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-getec-900 mb-4">Nos domaines d'expertise</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              GETEC OI vous propose une gamme complète de services pour accompagner vos projets de construction et d'infrastructure.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
              <div className="order-2 md:order-1">
                <div className="flex items-center mb-4">
                  <Building2 className="h-8 w-8 text-getec-700 mr-3" />
                  <h3 className="text-2xl font-bold text-getec-900">Bureau d'études techniques</h3>
                </div>
                ...
                <ul className="space-y-3 mb-6">
                  <li className="flex items-start">
                    <ArrowRight className="h-5 w-5 text-getec-600 mr-2 flex-shrink-0 mt-0.5" />
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div>
                <div className="flex items-center mb-4">
                  <CheckCircle2 className="h-8 w-8 text-getec-700 mr-3" />
                  <h3 className="text-2xl font-bold text-getec-900">Contrôle technique de construction</h3>
                </div>
                <p className="text-gray-700 mb-6">
                  En tant qu'organisme agréé, GETEC OI réalise des missions de contrôle technique pour
          ...
          <div className="mb-20">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
              <div className="order-2 md:order-1">
                <div className="flex items-center mb-4">
                  <Lightbulb className="h-8 w-8 text-getec-700 mr-3" />
                  <h3 className="text-2xl font-bold text-getec-900">Assistance à maîtrise d'ouvrage</h3>
                </div>
                <p className="text-gray-700 mb-6">
          ...
          <div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
              ...
              <div>
                <div className="flex items-center mb-4">
                  <Shield className="h-8 w-8 text-getec-700 mr-3" />
                  <h3 className="text-2xl font-bold text-getec-900">Coordination SPS</h3>
                </div>
                <p className="text-gray-700 mb-6">
      ...
      <section className="py-16 bg-getec-800 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Contactez-nous pour discuter de votre projet et découvrir comment GETEC OI peut vous accompagner.
          </p>
