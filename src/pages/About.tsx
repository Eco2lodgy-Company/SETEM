    ...
    <main>
      ...
      <section className="page-header">
        <div className="container mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">À propos de SETM OI</h1>
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-SETM-900 mb-6">Notre entreprise</h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center">
                  <Calendar className="h-6 w-6 text-SETM-600 mr-3" />
                  <div>
                ...
                <div className="flex items-center">
                  <DollarSign className="h-6 w-6 text-SETM-600 mr-3" />
                  <div>
                ...
                <div className="flex items-center">
                  <Users className="h-6 w-6 text-SETM-600 mr-3" />
                  <div>
                ...
                <div className="flex items-center">
                  <Award className="h-6 w-6 text-SETM-600 mr-3" />
                  <div>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-SETM-900 mb-4">Notre mission et nos valeurs</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-SETM-800 mb-4">Excellence technique</h3>
              <p className="text-gray-700">
                Nous nous efforçons de maintenir les plus hauts standards de qualité et d'expertise dans tous nos projets.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-SETM-800 mb-4">Engagement pour la sécurité</h3>
              <p className="text-gray-700">
                La sécurité est au cœur de nos préoccupations, tant dans nos méthodes de travail que dans les projets que nous contrôlons.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-SETM-800 mb-4">Innovation et adaptabilité</h3>
              <p className="text-gray-700">
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-SETM-900 mb-8 text-center">Nos références et expériences</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-SETM-800 mb-2">Constructions publiques</h3>
                <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-SETM-800 mb-2">Logements collectifs</h3>
                <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-SETM-800 mb-2">Établissements scolaires</h3>
                <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-SETM-800 mb-2">Infrastructures routières</h3>
                <p className="text-gray-700">
      ...
      {/* Certifications */}
      <section className="section-padding bg-SETM-800 text-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Certifications et engagements</h2>
            <p className="text-xl max-w-2xl mx-auto text-SETM-100">
