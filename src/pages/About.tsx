    ...
    <main>
      ...
      <section className="page-header">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl max-w-2xl mx-auto text-orange">
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#0055A4] mb-6">Notre entreprise</h2>
              <p className="text-gray-700 mb-4">
                Le Groupe d'Études Techniques et de Contrôle Océan Indien (SETM OI) est une SARL créée en 2006, 
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="flex items-center">
                  <Calendar className="h-6 w-6 text-[#F5A623] mr-3" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Créée en</h4>
                    <p className="text-gray-700">2006</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <DollarSign className="h-6 w-6 text-[#F5A623] mr-3" />
                  <div>
                ...
                <div className="flex items-center">
                  <Users className="h-6 w-6 text-[#F5A623] mr-3" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Effectif</h4>
                    <p className="text-gray-700">9 salariés</p>
                  </div>
                </div>
                <div className="flex items-center">
                  <Award className="h-6 w-6 text-[#F5A623] mr-3" />
                  <div>
                    <h4 className="font-semibold text-gray-800">Forme juridique</h4>
      ...
      <section className="section-padding bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-[#0055A4] mb-4">Notre mission et nos valeurs</h2>
            <p className="text-gray-700 max-w-2xl mx-auto">
              Chez SETM OI, nous nous engageons à fournir des services d'ingénierie de haute qualité, 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-[#0055A4] mb-4">Excellence technique</h3>
              <p className="text-gray-700">
                Nous nous efforçons de maintenir les plus hauts standards de qualité et d'expertise dans tous nos projets.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-[#0055A4] mb-4">Engagement pour la sécurité</h3>
              <p className="text-gray-700">
                La sécurité est au cœur de nos préoccupations, tant dans nos méthodes de travail que dans les projets que nous contrôlons.
              </p>
            </div>
            <div className="bg-white p-8 rounded-lg shadow-sm border border-gray-100">
              <h3 className="text-xl font-semibold text-[#0055A4] mb-4">Innovation et adaptabilité</h3>
              <p className="text-gray-700">
      ...
      <section className="section-padding">
        <div className="container mx-auto">
          <h2 className="text-3xl font-bold text-[#0055A4] mb-8 text-center">Nos références et expériences</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#0055A4] mb-2">Constructions publiques</h3>
                <p className="text-gray-700">
                  SETM OI a participé à la conception et au contrôle technique de nombreux édifices publics à La Réunion, 
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#0055A4] mb-2">Logements collectifs</h3>
                <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#0055A4] mb-2">Établissements scolaires</h3>
                <p className="text-gray-700">
            ...
            <div className="border border-gray-200 rounded-lg overflow-hidden shadow-sm">
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold text-[#0055A4] mb-2">Infrastructures routières</h3>
                <p className="text-gray-700">
                  SETM OI intervient également dans le domaine des infrastructures routières, 
      ...
      {/* Certifications */}
      <section className="section-padding bg-[#0055A4] text-white">
        <div className="container mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Certifications et engagements</h2>
            <p className="text-xl max-w-2xl mx-auto text-[#E6F0FA]">
              Notre engagement pour la qualité se traduit par des certifications et une démarche rigoureuse.
            </p>
          </div>

          <div className="max-w-3xl mx-auto">
            <div className="bg-[#F5A623]/10 backdrop-blur-sm p-6 rounded-lg mb-6">
              <h3 className="text-xl font-semibold mb-2">Agrément pour le contrôle technique</h3>
              <p className="text-[#E6F0FA]">
                SETM OI est agréé pour réaliser des missions de contrôle technique, 
            ...
            <div className="bg-[#F5A623]/10 backdrop-blur-sm p-6 rounded-lg">
