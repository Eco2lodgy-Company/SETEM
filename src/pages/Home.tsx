...
const Home = () => {
  ...
  const settings = {
    ...
    slidesToScroll: 1,
    autoplay: true,
    autoplaySpeed: 5000, // Changement toutes les 5 secondes
    arrows: true,
    fade: true,
    pauseOnHover: true,
  ...
  return (
    <main>
      {/* Hero Section - Carrousel pleine page avec écritures descendues */}
          ...
          {heroSlides.map((slide, index) => (
            <div key={index} className="relative h-screen min-h-[600px] flex flex-col">
              ...
              <div className="container mx-auto px-4 pt-32 md:pt-40 lg:pt-48 relative z-10">
                ...
                >
                  <motion.span
                    className="inline-block px-4 py-2 bg-SETM-500/30 text-SETM-100 rounded-full text-sm font-semibold mb-6 tracking-wide"
                  ...
                  <motion.p
                    className="text-lg md:text-xl text-SETM-100 mb-8 leading-relaxed"
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                  ...
                  <motion.p
                    className="text-md md:text-lg text-SETM-200 mb-8 font-semibold"
      ...
      {/* Services Preview - Grille statique inchangée */}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-6 rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow text-center">
              ...
              <Link
                to="/services"
                className="text-SETM-700 hover:text-SETM-800 font-medium inline-flex items-center"
              >
                En savoir plus
              </Link>
            </div>
